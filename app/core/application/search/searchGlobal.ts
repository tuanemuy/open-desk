...
export async function searchGlobal({
  container,
  input,
}: ServiceArgs<SearchGlobalInput>): Promise<SearchOutput> {
  const scope = SearchScope.global();
  const dateRange =
  ...
  // SearchQuery.create validates keyword, offset, limit, and sourceType availability
